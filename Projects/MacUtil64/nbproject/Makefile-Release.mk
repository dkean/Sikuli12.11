...
${OBJECTDIR}/_ext/1344807628/MacUtil.o: ../../Resources/natives/Mac/OSUtilMac/MacUtil.m 
	...
	${RM} $@.d
	$(COMPILE.cc) -O3 -s -I/usr/local/include -I/System/Library/Frameworks/JavaVM.framework/Headers -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1344807628/MacUtil.o ../../Resources/natives/Mac/OSUtilMac/MacUtil.m
