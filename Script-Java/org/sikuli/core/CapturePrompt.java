...
public class CapturePrompt extends TransparentWindow implements Subject {
	...
	private void init(Screen scr, Observer ob) {
		addObserver(ob);
		if (scr == null) {
		...
		addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(java.awt.event.MouseEvent e) {
				...
				Debug.log(2, "CapturePrompt: started at " + srcx + "," + srcy + " at screen " + srcScreenId);
				repaint();
			}
			...
			public void mouseReleased(java.awt.event.MouseEvent e) {
				...
				if (e.getButton() == java.awt.event.MouseEvent.BUTTON3) {
					...
					Debug.log(2, "CapturePrompt: finished at " + e.getX() + "," + e.getY());
				}
				setVisible(false);
				notifyObserver();
			}
