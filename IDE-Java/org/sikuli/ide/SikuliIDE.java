...
//    new ScriptRunner(getPyArgs(null));
    ...
    setSize(_windowSize);
    setLocation(PreferencesUser.getInstance().getIdeLocation());
...
// RaiMan not used
  ...
  class RunAction extends MenuAction {
    ...
    private void askForSaveAll() {
//TODO: save all at run
      String warn = "ask for action";
      JOptionPane.showMessageDialog(SikuliIDE.getInstance(), warn,
              "--- Some scripts are not saved yet ---", JOptionPane.WARNING_MESSAGE);
    }
  }
  //</editor-fold>
