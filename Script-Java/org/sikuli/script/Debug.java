 ...
 * /> -Dsikuli.logfile=pathname or logfile=pathname (no path given:
 * SikuliLog.txt in working folder)
 */
public class Debug {
  ...
  /**
   * Sikuli messages from actions like click, ...<br /> switch on/off:
   * Settings.ActionLogs
   *
  ...
  /**
   * Sikuli debug messages with default level<br /> switch on/off:
   * Settings.DebugLogs (off) and/or -Dsikuli.Debug
   *
   * @param message (String or format string)
   * @param args to use with format string
   */
  ...
  /**
   * Sikuli debug messages with level<br /> switch on/off: Settings.DebugLogs
   * (off) and/or -Dsikuli.Debug
   *
   * @param level
   * @param message (String or format string)
   * @param args to use with format string
  ...
  /**
   * Sikuli profiling messages<br /> switch on/off: Settings.ProfileLogs,
   * default off
   *
   * @param message (String or format string)
   * @param args to use with format string
  ...
  /**
   * start the timer<br />
   * usage: Debug timer = new Debug(); timer.startTiming(...)
   * @param message (String or format string)
   * @param args to use with format string
   */
  ...
  /**
   * convenience: silently start timer<br />
   * usage: Debug timer = new Debug(); timer.start(); ... timer.end();
   */
  public void start() {
    startTiming("");
  }
