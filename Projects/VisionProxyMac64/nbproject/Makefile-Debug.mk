...
LDLIBSOPTIONS=-dynamic /usr/local/lib/libopencv_core.dylib /usr/local/lib/libopencv_features2d.dylib /usr/local/lib/libopencv_highgui.dylib /usr/local/lib/libopencv_imgproc.dylib /usr/local/lib/libtesseract.dylib

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libVisionProxy.jnilib

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libVisionProxy.jnilib: /usr/local/lib/libopencv_core.dylib

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libVisionProxy.jnilib: /usr/local/lib/libopencv_features2d.dylib

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libVisionProxy.jnilib: /usr/local/lib/libopencv_highgui.dylib

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libVisionProxy.jnilib: /usr/local/lib/libopencv_imgproc.dylib

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libVisionProxy.jnilib: /usr/local/lib/libtesseract.dylib
...
${OBJECTDIR}/_ext/1240717019/sikuli-debug.o: ../../Resources/natives/Vision/sikuli-debug.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1240717019
	${RM} $@.d
	$(COMPILE.cc) -g -I/usr/local/include -I/usr/local/include/opencv -I/usr/local/include/tesseract -I/System/Library/Frameworks/JavaVM.framework/Headers -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1240717019/sikuli-debug.o ../../Resources/natives/Vision/sikuli-debug.cpp
...
${OBJECTDIR}/_ext/1240717019/visionJAVA_wrap.o: ../../Resources/natives/Vision/visionJAVA_wrap.cxx 
	${MKDIR} -p ${OBJECTDIR}/_ext/1240717019
	${RM} $@.d
	$(COMPILE.cc) -g -I/usr/local/include -I/usr/local/include/opencv -I/usr/local/include/tesseract -I/System/Library/Frameworks/JavaVM.framework/Headers -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1240717019/visionJAVA_wrap.o ../../Resources/natives/Vision/visionJAVA_wrap.cxx
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libVisionProxy.jnilib
